...
static const char *C_API_FUNCTIONS = "wb_accelerometer_enable "
                                     ...
                                     "wb_radio_nuclear_detector_disable"
                                     "wb_radio_nuclear_detector_enable"
                                     "wb_radio_nuclear_detector_get_sampling_period"
                                     "wb_radio_nuclear_detector_get_measurement"
                                     "wb_radio_nuclear_source_get_range"
                                     "wb_radio_nuclear_source_set_range"
...
static const char *C_API_CONSTANTS = "INFINITY "
                                     ...
                                     "WB_NODE_PROPELLER "
                                     "WB_NODE_RADAR "
                                     "WB_NODE_RADIO_NUCLEAR_DETECTOR"
                                     "WB_NODE_RADIO_NUCLEAR_SOURCE"
...
static const char *API_CLASSES =
  ...
  "MouseState Node Pen PositionSensor Radar RadioNuclearDetector RadioNuclearSource RadarTarget RangeFinder Receiver Robot RotationalMotor "
